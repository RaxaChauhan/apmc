...
class janshiDailyIncome : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_janshi_daily_income)
        ...
        getjanshiIncome().execute(Currentdate)
        ...
        textview_date!!.setOnClickListener(object : View.OnClickListener {
            override fun onClick(view: View) {
                DatePickerDialog(this@janshiDailyIncome,
    ...
    inner class getjanshiIncome : AsyncTask<String, String, String>(){
        ...
        override fun onPostExecute(result: String?) {
            ...
            try{
                ...
                if (jresult != null && jresult.isNotEmpty()){
                    ...
                    tableRowAdapter = IncomeRowAdapter(jresult, 0)

                    tableRecyclerView.layoutManager = LinearLayoutManager(this@janshiDailyIncome)
                    tableRecyclerView.adapter = tableRowAdapter

                }
                else{
                    Toast.makeText(this@janshiDailyIncome, "no data", Toast.LENGTH_SHORT ).show()
