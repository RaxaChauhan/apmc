...
class vegDaily_price : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_veg_daily_price)
        ...
        //date
        textview_date = findViewById(R.id.vegdate)
        ...
        textview_date!!.setOnClickListener(object : View.OnClickListener {
            override fun onClick(view: View) {
                DatePickerDialog(this@vegDaily_price,
        ...
        override fun onPostExecute(result: String?) {
            ...
            try{
                ...
                if (jresult != null && jresult.isNotEmpty()){
                    ...
                    //recycleview
                    tableRecyclerView = findViewById(R.id.vegtable_recycler_view)
                    tableRowAdapter = TableRowAdapter(jresult)

                    tableRecyclerView.layoutManager = LinearLayoutManager(this@vegDaily_price)
                    tableRecyclerView.adapter = tableRowAdapter

                }
                else{
                    Toast.makeText(this@vegDaily_price, "no data", Toast.LENGTH_SHORT ).show()
