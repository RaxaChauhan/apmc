...
class frtDailyIncome : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_frt_daily_income)
        ...
        getfrtIncome().execute(Currentdate)
        ...
        textview_date!!.setOnClickListener(object : View.OnClickListener {
            override fun onClick(view: View) {
                DatePickerDialog(this@frtDailyIncome,
    ...
    inner class getfrtIncome : AsyncTask<String, String, String>(){
        ...
        override fun onPostExecute(result: String?) {
            ...
            try{
                ...
                if (jresult != null && jresult.isNotEmpty()){
                    ...
                    tableRecyclerView.layoutManager = LinearLayoutManager(this@frtDailyIncome)
                    tableRecyclerView.adapter = tableRowAdapter

                }
                else{
                    Toast.makeText(this@frtDailyIncome, "no data", Toast.LENGTH_SHORT ).show()
